...
def getCPULoadRate():
    ...
    usageRate =int(float(usage * 100/ total)*1500/1750)
...
def setOLEDshow():
    ...
    draw.text((x+56, top+16), str(CPU_TEMP), font=font, fill=255)
    draw.text((x, top+24), str(MemUsage),  font=font, fill=255)
    draw.text((x+56, top+24), str(Disk),  font=font, fill=255)
